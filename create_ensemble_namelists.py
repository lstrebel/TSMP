...
def write_mosart_in(iens):
    ...
    nl_string += '  frivinp_rtm = "/p/scratch/cjicg41/jicg4177/cesm/inputdata/"\n'
...
def write_datm_in(syear, eyear, iens):
    ...
    nl_string += ('  domainfile = "/p/scratch/cjicg41/jicg4177/cesm/inputdata/share/domains/' +
                   'domain.lnd.1x1_wuestebach_west_1x1_wuestebach_west.190819.nc"\n')
    ...
    nl_string += ('  streams = "user_datm.streams.clm1PT.1x1pt_wuestebach_west.solar.stream_'
                    + str(iens).zfill(4)+'.txt '+str(syear)+' '+str(syear)+' '+str(eyear)+'",\n')
    nl_string += ('            "user_datm.streams.clm1PT.1x1pt_wuestebach_west.precip.stream_'
                    + str(iens).zfill(4)+'.txt '+str(syear)+' '+str(syear)+' '+str(eyear)+'",\n')
    nl_string += ('            "user_datm.streams.clm1PT.1x1pt_wuestebach_west.other.stream_'
                    + str(iens).zfill(4)+'.txt '+str(syear)+' '+str(syear)+' '+str(eyear)+'",\n')
...
def write_drv_flds_in():
    ...
    nl_string += ("  megan_factors_file = '/p/scratch/cjicg41/jicg4177/cesm/inputdata/atm/cam/" +
...
def write_drv_in(rundir, syear, eyear, prefix=None):
    ...
    nl_string += '  stop_ymd = '+str(eyear)+'1231\n'
...
def write_lnd_in(syear, eyear, iens, prefix="clmoas"):
    ...
    nl_string += " fatmlndfrc = '/p/scratch/cjicg41/jicg4177/cesm/inputdata/share/domains/domain.lnd.1x1_wuestebach_west_1x1_wuestebach_west.190819.nc'\n"
    if syear == 2009:
        nl_string += " finidat = '/p/scratch/cjicg41/jicg4177/1x1_wuestebach_west_spinup/run/1x1_wuestebach_west_spinup.clm2.r.2350-01-01-00000.nc'\n"
    else:
        nl_string+=" finidat = '/p/scratch/cjicg41/jicg4177/CLM5PDAF/wuestebach_west/"+str(prefix)+".clm2_"+str(iens).zfill(4)+".r."+str(syear)+"-01-01-00000.nc'\n"
    nl_string += " fsnowaging = '/p/scratch/cjicg41/jicg4177/cesm/inputdata/lnd/clm2/snicardata/snicar_drdt_bst_fit_60_c070416.nc'\n"
    nl_string += " fsnowoptics = '/p/scratch/cjicg41/jicg4177/cesm/inputdata/lnd/clm2/snicardata/snicar_optics_5bnd_c090915.nc'\n"
    nl_string += " fsurdat = '/p/scratch/cjicg41/jicg4177/cesm/inputdata/lnd/clm2/surfdata_map/release-clm5.0.18/wuestebach_west_ensemble/surfdata_1x1_wuestebach_west_hist_78pfts_CMIP6_simyr2000_c191025_"+str(iens+1).zfill(5) + ".nc'\n"
    ...
    nl_string += " paramfile = '/p/scratch/cjicg41/jicg4177/cesm/inputdata/lnd/clm2/paramdata/clm5_params.c171117.nc'\n"   
    ...
    nl_string += " stream_fldfilename_ndep = '/p/scratch/cjicg41/jicg4177/cesm/inputdata/lnd/clm2/ndepdata/fndep_clm_hist_b.e21.BWHIST.f09_g17.CMIP6-historical-WACCM.ensmean_1849-2015_monthly_0.9x1.25_c180926.nc'\n"
    ...
    nl_string += " stream_fldfilename_popdens = '/p/scratch/cjicg41/jicg4177/cesm/inputdata/lnd/clm2/firedata/clmforc.Li_2017_HYDEv3.2_CMIP6_hdm_0.5x0.5_AVHRR_simyr1850-2016_c180202.nc'\n"
    nl_string += " stream_year_first_popdens = 2000\n"
    nl_string += " stream_year_last_popdens = 2000\n"
    nl_string += "/\n"
    nl_string += "&urbantv_streams\n"
    nl_string += " stream_fldfilename_urbantv = '/p/scratch/cjicg41/jicg4177/cesm/inputdata/lnd/clm2/urbandata/CLM50_tbuildmax_Oleson_2016_0.9x1.25_simyr1849-2106_c160923.nc'\n"
    ...
    nl_string += " stream_fldfilename_lightng = '/p/scratch/cjicg41/jicg4177/cesm/inputdata/atm/datm7/NASA_LIS/clmforc.Li_2012_climo1995-2011.T62.lnfm_Total_c140423.nc'\n"
    ...
    nl_string += " stream_fldfilename_ch4finundated = '/p/scratch/cjicg41/jicg4177/cesm/inputdata/lnd/clm2/paramdata/finundated_inversiondata_0.9x1.25_c170706.nc'\n"
    nl_string += "/\n"
...
def write_stream_files(iens, stream):
    ...
    nl_string += '  </variableNames>\n'
    nl_string += '  <filePath>\n'
    nl_string += '     /p/scratch/cjicg41/jicg4177/cesm/inputdata/share/domains\n'
    nl_string += '  </filePath>\n'
    nl_string += '  <fileNames>\n'
    nl_string += '     domain.lnd.1x1_wuestebach_west_1x1_wuestebach_west.190819.nc\n'
    nl_string += '  </fileNames>\n'
    nl_string += '</domainInfo>\n'
    nl_string += '<fieldInfo>\n'
    nl_string += '   <variableNames>\n'
    ...
    nl_string += '   </variableNames>\n'
    nl_string += '   <filePath>\n'
    nl_string += '     /p/scratch/cjicg41/jicg4177/cesm/inputdata/atm/datm7/1x1_wuestebach_west/ensemble/real_' + str(iens+1).zfill(5) + '\n'
    nl_string += '   </filePath>\n'
    nl_string += '   <fileNames>\n'
    ...
    with open("user_datm.streams.clm1PT.1x1pt_wuestebach_west."+stream+".stream_" +
...
if __name__ == "__main__":
    ...
    num_ensemble = 96
    b_dir = "/p/project/cjicg41/jicg4177/tsmp-clm-dev/terrsysmp/clm5_0_JURECA_4.4.0MCTPDAF_clm/build"
    r_dir = "/p/scratch/cjicg41/jicg4177/CLM5PDAF/wuestebach_west"
